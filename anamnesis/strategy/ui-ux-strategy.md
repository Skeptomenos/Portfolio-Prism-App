...
> **Also read:** `anamnesis/strategy/application-shell.md` for shell strategy
> **Also read:** `anamnesis/strategy/language-stack.md` for language strategy
> **Also read:** `anamnesis/strategy/data-architecture.md` for data strategy
> **Also read:** `anamnesis/strategy/external-integrations.md` for integration strategy
