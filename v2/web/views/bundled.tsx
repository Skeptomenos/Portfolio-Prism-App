...
import { amundiPluginMetadata, eventsPlugin, historyPlugin, wikiPlugin, financialPlugin, contributionMixPlugin } from './plugin-metadata'
...
export const browserViews = new BrowserViewRegistry([
  ...
  { metadata: eventsPlugin, viewId: 'portfolio-events', render: () => <Events client={eventsClient} /> },
