...
export const summarySchema = Schema.Struct({
  id: text, runId: text, recordedAt: date, reason: Schema.Literal('holdings', 'valuation', 'composition', 'migration', 'manual-evidence'), datasetId: text,
...
export const runSchema = Schema.Struct({ id: text, trigger: Schema.Literal('broker-sync', 'composition-refresh', 'migration', 'manual-evidence'), startedAt: date, finishedAt: Schema.NullOr(date),
