...
const suites = {
  ...
  broker: ['tests/event-ledger.test.ts', 'tests/explorer.test.ts', 'tests/broker-connections.test.ts', 'tests/connection-contract.test.ts', 'tests/connection-security.test.ts', 'tests/broker-cash-retention.test.ts', 'tests/quantity-observations.test.ts'],
