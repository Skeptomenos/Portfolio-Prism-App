...
const suites = {
  ...
  broker: ['tests/broker-connections.test.ts', 'tests/connection-contract.test.ts', 'tests/connection-security.test.ts', 'tests/broker-cash-retention.test.ts', 'tests/quantity-observations.test.ts'],
  view: ['tests/browser-view-registry.test.ts', 'tests/browser-boundary.test.ts', 'tests/financial-contracts.test.ts', 'tests/history-view-client.test.ts'],
