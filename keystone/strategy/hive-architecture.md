...
> **Also read:** `keystone/strategy/data-architecture.md` for local storage context.
> **Also read:** `keystone/strategy/external-integrations.md` for trust scoring logic.
