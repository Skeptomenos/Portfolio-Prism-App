...
## Open
- [ ] **GH-028:** Hive log shows same contributions every pipeline run. `[issue-tracker]`
- [ ] **GH-029:** Add explanation for "Exposure Distribution". `[issue-tracker]`
- [ ] **GH-030:** Add explanation for "Confidence Score". `[issue-tracker]`
- [ ] **GH-031:** True exposure missing direct holdings (e.g., NVDA direct + 7 ETFs). `[issue-tracker]`
- [ ] **GH-032:** Dashboard missing top 10 true exposure widget. `[issue-tracker]`
- [ ] **GH-033:** Action cue Fix/Ignore buttons have no functionality. `[issue-tracker]`
