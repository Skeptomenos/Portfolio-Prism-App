...
## Blocked
- [ ] **DECOUPLE-002:** Update sync tests `[hive-extension]` (Deps: DECOUPLE-001)
- [ ] **DECOUPLE-006:** Delete browser.py `[hive-extension]` (Deps: DECOUPLE-004, DECOUPLE-005)
- [ ] **DECOUPLE-007:** Update adapter error handling `[hive-extension]` (Deps: DECOUPLE-006)
- [ ] **DECOUPLE-008:** Run test suite `[hive-extension]` (Deps: DECOUPLE-001, DECOUPLE-002, DECOUPLE-003)
- [ ] **DECOUPLE-009:** Live integration test `[hive-extension]` (Deps: DECOUPLE-008)
...
## Open
- [ ] **DECOUPLE-001:** Remove pipeline auto-trigger from sync handler `[hive-extension]`
- [ ] **DECOUPLE-003:** Change USE_LEGACY_CSV default to false `[hive-extension]`
- [ ] **DECOUPLE-004:** Simplify AmundiAdapter (remove Playwright) `[hive-extension]`
- [ ] **DECOUPLE-005:** Simplify VanguardAdapter (remove Playwright) `[hive-extension]`
