...
| ``identity-resolution`` | `keystone/project/workstreams/identity-resolution.md` | ``root-session`` | `Active` |
...
## Open
- [ ] **IR-301:** Move negative cache to SQLite (isin_cache table) `[main]`
  - 📅 2025-12-27
- [ ] **IR-302:** Remove legacy enrichment_cache.json `[main]`
  - 📅 2025-12-27
- [ ] **IR-303:** Add TTL tracking for SQLite negative cache `[main]`
  - 📅 2025-12-27
- [ ] **IR-304:** Add tests for persistent negative cache `[main]`
  - 📅 2025-12-27
- [ ] **IR-401:** Store resolution source/confidence per holding in DataFrame `[main]`
  - 📅 2025-12-27
...
## Backlog
- [ ] **IR-402:** Surface provenance in UI (optional) `[main]`
  - 📅 2025-12-27
