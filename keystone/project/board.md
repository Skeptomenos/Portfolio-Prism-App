...
## Blocked
- [ ] **HIVE-002:** Create `resolve_ticker_rpc` function `[hive-extension]` (Deps: HIVE-001)
- [ ] **HIVE-003:** Create `batch_resolve_tickers_rpc` function `[hive-extension]` (Deps: HIVE-001)
- [ ] **HIVE-004:** Create `lookup_alias_rpc` function `[hive-extension]` (Deps: HIVE-005)
- [ ] **HIVE-006:** Create `contribute_alias` RPC `[hive-extension]` (Deps: HIVE-005)
- [ ] **HIVE-007:** Verify RLS fix works `[hive-extension]` (Deps: HIVE-002, HIVE-003)
- [ ] **HIVE-101:** Add `resolve_ticker()` method `[hive-extension]` (Deps: HIVE-007)
- [ ] **HIVE-102:** Add `batch_resolve_tickers()` method `[hive-extension]` (Deps: HIVE-007)
- [ ] **HIVE-103:** Add `lookup_by_alias()` method `[hive-extension]` (Deps: HIVE-007)
- [ ] **HIVE-104:** Add `sync_identity_domain()` method `[hive-extension]` (Deps: HIVE-101)
- [ ] **HIVE-105:** Unit tests for HiveClient read methods `[hive-extension]` (Deps: HIVE-101, HIVE-102, HIVE-103)
- [ ] **HIVE-201:** Create LocalCache SQLite schema `[hive-extension]` (Deps: HIVE-005)
- [ ] **HIVE-202:** Implement LocalCache CRUD operations `[hive-extension]` (Deps: HIVE-201)
- [ ] **HIVE-203:** Implement sync logic `[hive-extension]` (Deps: HIVE-202, HIVE-104)
- [ ] **HIVE-204:** Implement staleness check `[hive-extension]` (Deps: HIVE-203)
- [ ] **HIVE-205:** Unit tests for LocalCache `[hive-extension]` (Deps: HIVE-202, HIVE-203, HIVE-204)
- [ ] **HIVE-302:** Refactor ISINResolver with dual path `[hive-extension]` (Deps: HIVE-301, HIVE-105, HIVE-205)
- [ ] **HIVE-303:** Implement Hive-first resolution chain `[hive-extension]` (Deps: HIVE-302)
- [ ] **HIVE-304:** Implement push-to-Hive on API success `[hive-extension]` (Deps: HIVE-303)
- [ ] **HIVE-305:** Implement tiered resolution `[hive-extension]` (Deps: HIVE-303)
- [ ] **HIVE-306:** Unit tests for ISINResolver refactor `[hive-extension]` (Deps: HIVE-302, HIVE-303, HIVE-304)
- [ ] **HIVE-401:** Inject ISINResolver into Decomposer `[hive-extension]` (Deps: HIVE-306)
- [ ] **HIVE-402:** Call resolver after adapter fetch `[hive-extension]` (Deps: HIVE-401)
- [ ] **HIVE-403:** Add resolution stats logging `[hive-extension]` (Deps: HIVE-402)
- [ ] **HIVE-404:** Integration test for X-Ray pipeline `[hive-extension]` (Deps: HIVE-402)
- [ ] **HIVE-501:** Delete AssetUniverse class `[hive-extension]` (Deps: HIVE-404 (production verified))
- [ ] **HIVE-502:** Remove CSV from migration.py `[hive-extension]` (Deps: HIVE-501)
- [ ] **HIVE-503:** Remove feature flag `[hive-extension]` (Deps: HIVE-502)
- [ ] **HIVE-504:** Delete deprecated files `[hive-extension]` (Deps: HIVE-503)
- [ ] **HIVE-505:** Final documentation update `[hive-extension]` (Deps: HIVE-504)
...
## Open
- [ ] **HIVE-001:** Audit current RLS policies `[hive-extension]`
- [ ] **HIVE-005:** Add `aliases` table migration `[hive-extension]`
- [ ] **HIVE-301:** Add `USE_LEGACY_CSV` feature flag `[hive-extension]`
