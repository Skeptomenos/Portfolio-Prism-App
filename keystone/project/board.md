...
## Open
- [ ] **IR-301:** Add isin_cache table to LocalCache schema `[main]`
- [ ] **IR-302:** Add LocalCache methods for isin_cache `[main]`
- [ ] **IR-303:** Replace in-memory negative cache with SQLite `[main]`
- [ ] **IR-304:** Remove legacy enrichment_cache.json `[main]`
- [ ] **IR-305:** Add tests for persistent negative cache `[main]`
