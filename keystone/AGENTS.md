...
1. **State:** Read `keystone/.context/mission.md` + `keystone/.context/active_state.md` at session start
...
| Task | File |
|------|------|
| Session start | `keystone/.context/mission.md` + `keystone/.context/active_state.md` |
...
| Python code | `keystone/standards/global.md` + `keystone/standards/python.md` |
| Rust/Tauri code | `keystone/standards/global.md` + `keystone/standards/rust.md` |
...
`keystone/.context/active_state.md` (current) | `keystone/.context/handover.md` (previous) | `keystone/specs/tasks.md` (plan)
