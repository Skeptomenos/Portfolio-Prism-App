...
| P-26 | Browser tab crashes during pipeline at ~25% | Medium | User reported browser "closed or crashed" at 25% progress. Engine continues running. May be frontend memory issue or SSE event flood. | **investigate** |
