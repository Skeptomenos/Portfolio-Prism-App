...
> **Classification: Useful V1 reference — V1 only.** Archived 2026-09-07.
> Read when: Investigate dated V1 testing limitations.
...
- The docs in `docs/v1/execution/codex-install-config-plan.md` are accurate for Codex, but incomplete for OpenCode.
...
- Update `docs/v1/execution/codex-install-config-plan.md` to include OpenCode compatibility notes.
...
- Primary live plan: `docs/v1/execution/stabilization-and-self-dogfood-plan.md`
- Self-testing/install doc: `docs/v1/execution/codex-install-config-plan.md`
- This handoff report: `docs/v1/execution/self-testing-capability-gap-report-2026-03-07.md`
