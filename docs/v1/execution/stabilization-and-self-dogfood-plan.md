...
> V1 historical plan. Since 2026-09-06, the V2 project and delivery plan, reached through the [project index](../../../index.md), owns rebuild phases and execution status. The content below is retained for V1 reference; its “live” labels describe the earlier workflow.
...
- [x] Shared skill strategy is standardized on `$HOME/.agents/skills`.
  ...
  - Evidence: `docs/v1/execution/opencode-self-testing-runbook.md`, `report.md`
...
- [x] Active runbooks and AGENTS entrypoints have been updated to the OpenCode/selftest model.
  ...
  - Evidence: `AGENTS.md`, `Portfolio-Prism/AGENTS.md`, `docs/v1/execution/opencode-self-testing-runbook.md`
...
- Moved live execution docs and implementation plans from the wrapper `planning/` area into inner `docs/v1/execution/`.
