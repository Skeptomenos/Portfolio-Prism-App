...
- `docs/v1/execution/codex-install-config-plan.md` remains useful as historical machine-setup context, but this runbook is the active runtime/testing reference.
