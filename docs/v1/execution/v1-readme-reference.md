...
> Read when: Recover V1 setup and architecture context.
...
Archived on 2026-09-06 during the V2 documentation alignment. The original text below is historical, including its release claims, setup paths and architecture choices. It is not current acceptance evidence. Use the [project README](../../../README.md) for the product and [V2 README](../../../v2/README.md) for current setup.
