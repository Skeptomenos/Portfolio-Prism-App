...
> **Classification: Obsolete — V1 only.** Archived 2026-09-07.
> Read when: Retained as dated tooling history only. Machine setup and capability claims require a new audit.
