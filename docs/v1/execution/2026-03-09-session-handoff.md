...
| Document                                          | What                                              |
| ------------------------------------------------- | ------------------------------------------------- |
| `docs/v1/specs/pipeline_definition_of_done.md`         | Created — canonical pipeline success criteria     |
| `docs/v1/architecture/unified_data_schema.md`          | Created — target schema for P-28 refactor         |
| `docs/v1/plans/2026-03-08-pipeline-stabilization-plan.md` | 28 tracked issues, dogfood logs, readiness checklist |
| `docs/v1/plans/2026-03-08-session-restore-dogfood-fix-plan.md` | Session restore fix plan (completed)       |
| `docs/v1/specs/identity_resolution_details.md`         | Updated — synchronized with implementation        |
| `docs/v1/architecture/identity_resolution.md`          | Updated — synchronized with implementation        |
| `docs/v1/specs/supabase_hive.md`                       | Updated — references unified schema               |
| `docs/v1/architecture/database_schema.md`              | Updated — references unified schema               |
| `docs/v1/specs/data_model.md`                          | Updated — references unified schema               |
...
### Design Document
`docs/v1/architecture/unified_data_schema.md` — 468 lines, fully specified:
...
### Implementation Plan
Read `docs/v1/plans/2026-03-08-pipeline-stabilization-plan.md` section "P-28: Implementation Readiness"
...
```
1. Read docs/v1/plans/2026-03-08-pipeline-stabilization-plan.md (the live plan)
2. Read docs/v1/architecture/unified_data_schema.md (the target schema)
