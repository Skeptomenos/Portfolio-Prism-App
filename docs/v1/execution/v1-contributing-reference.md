# V1 contribution reference

> **Classification: Useful V1 reference — V1 only.** Archived 2026-09-07.
> Read when: Maintain V1 frontend and testing conventions.
...
Archived on 2026-09-06. The commands and patterns below apply to the earlier implementation and require verification before use. Use the [current contribution guide](../../../CONTRIBUTING.md) for V2.
