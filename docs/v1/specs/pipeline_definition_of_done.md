...
> **Related:**
> - `docs/v1/architecture/analytics_pipeline.md` (pipeline architecture)
> - `docs/v1/architecture/unified_data_schema.md` (target schema for local cache + Hive)
> - `docs/v1/architecture/identity_resolution.md` (ISIN resolution architecture)
> - `docs/v1/specs/identity_resolution_details.md` (resolution cascade, confidence scores)
> - `docs/v1/specs/supabase_hive.md` (Hive community database)
> - `docs/v1/plans/2026-03-08-pipeline-stabilization-plan.md` (active stabilization work)
